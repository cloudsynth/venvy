...
```
curl -SL https://github.com/pnegahdar/venvy/releases/download/0.0.1/darwin_amd64 > /usr/local/bin/venvy && \
...
```
curl -SL https://github.com/pnegahdar/venvy/releases/download/0.0.1/linux_amd64 > /usr/local/bin/venvy && \
    chmod +x /usr/local/bin/venvy
```
